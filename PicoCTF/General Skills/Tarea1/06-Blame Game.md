...
## Solución 2
Vemos que autores han realizado commits para buscar el culpable ([[ic/comunes/software/programación/GitHub/Git#1️⃣ Ver una lista de autores y cantidad de commits]]).
```bash
