...
(None)
# Solución
Descargamos el archivo [[wget]].
```bash
┌──(kali㉿kali)-[~/macr]  
└─$ wget [https://mercury.picoctf.net/static/3944a59474f9f676942282c50b9c3675/Forensics%20is%20fun.pptm](https://mercury.picoctf.net/static/3944a59474f9f676942282c50b9c3675/Forensics%20is%20fun.pptm)  
--2025-05-05 15:10:22--  [https://mercury.picoctf.net/static/3944a59474f9f676942282c50b9c3675/Forensics%20is%20fun.pptm](https://mercury.picoctf.net/static/3944a59474f9f676942282c50b9c3675/Forensics%20is%20fun.pptm)  
...
Forensics is fun.pp 100%[================>]  97.75K   357KB/s    in 0.3s      
  

2025-05-05 15:10:31 (357 KB/s) - ‘Forensics is fun.pptm’ saved [100093/100093]
```
Nos damos cuenta que se trata de un archivo .pptm que ejecuta [[Macros]] en Windows.

Estos archivos son en realidad un zip, por lo que lo descomprimimos.
```bash
┌──(kali㉿kali)-[~/macr]  
...
Después de analizar las banderas, nos damos cuenta que la bandera puede que este escondida en: 'ppt/slideMasters/hidden'.
```bash
┌──(kali㉿kali)-[~/macr]  
...
Sin embargo nos damos cuenta que se encuentra en [[Codificación Base 64]], por lo que lo transformamos.
```bash
┌──(kali㉿kali)-[~/macr]  
